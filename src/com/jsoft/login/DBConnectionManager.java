...
-------
Date		Author			Action
16/11/2011	Alok				Modified for WSCI as Mail Alert of Errors
*********************************************************************************/
...
public class DBConnectionManager
{
	...
	private DBConnectionManager()
        ...
        public void freeConnection(String name, Connection con)
    	{
        	...
        	if (pool != null)
        	{
            	log("banking:Ready to free connection ");
			pool.freeConnection(con);
			log("banking:free connection ");
        	}
    	}
    	...
    	public Connection getConnection(String name)
    	{
        	...
        	if (pool != null)
        	{
			log("banking:Ready to getConnection ");
			return pool.getConnection();
			

        	}
log("banking:in getConnection pool was null");
        	return null;
    	}
	...
	private void log(String msg)
	{
        ...
        class DBConnectionPool
        {
        	...
        	private String user;
                ...
                {
            		Connection con = null;
log("banking:Size of Vectore(freeConnections :  "+freeConnections.size());
